            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Obx(() => TextButton(
                        onPressed:
                            controller.title.value.isNotEmpty ? () {} : null,
                        child: Text(
                          'Add',
                          style: TextStyle(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Obx(() => CupertinoSwitch(
                                          ...
                                          onChanged: (value) {controller.updateCalendarEnabled(value);
                                            if (value) {
                                              showDatePicker(
                                                context: context,
                                          ...
                                          onChanged: (value) async {
                                            ...
                                            if (value) {
                                              ...
                                              if (pickedTime != null) {
                                                ...
                                                controller.updateSelectedTime(const TimeOfDay(hour: 12, minute: 0));
                                              }
                                              Navigator.pop(context);
                                            }
                                          },
